  ...
  return (
    <>
      <div className="flex min-h-screen">
        <aside className="w-16 lg:w-64 bg-gray-800 text-white flex flex-col items-center lg:items-start p-4 space-y-4">
            <Image src="/logosvgnewwhite.svg" alt="logo coficab" width={200} height={50} />
          <h1 className="hidden lg:block text-xl font-bold mb-4"> admin Panel</h1>
          <nav className="flex flex-col items-center lg:items-start space-y-4 w-full">
            ...
            >
              ...
              <span className="hidden lg:inline">Demandes d&apos;attestation</span>
            </a>
            <a
            ...
            >
              ...
              <span className="hidden lg:inline">Changement de parada</span>
            </a>
